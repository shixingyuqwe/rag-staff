...
export default function TargetCursor({
  ...
  useEffect(() => {
    ...
    const enterHandler = (event: MouseEvent) => {
      ...
      if (!(directTarget instanceof HTMLElement)) return;
  ...
  return (
    <div ref={cursorRef} className={styles.wrapper}>
      ...
      <div className={`${styles.corner} ${styles.cornerTl}`} style={{ borderColor: cursorColor }} />
      <div className={`${styles.corner} ${styles.cornerTr}`} style={{ borderColor: cursorColor }} />
      <div className={`${styles.corner} ${styles.cornerBr}`} style={{ borderColor: cursorColor }} />
      <div className={`${styles.corner} ${styles.cornerBl}`} style={{ borderColor: cursorColor }} />
    </div>
  );
}
